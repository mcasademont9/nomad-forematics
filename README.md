...
NOMAD plugin for forematics experiments
...
```sh
git clone https://github.com/mcasademont9/nomad-forematics.git
cd nomad-forematics
...
```sh
pip install dist/nomad-forematics-0.1.0
```
